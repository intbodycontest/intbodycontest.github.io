...
$(document).ready(function(){
	...
	$.ajax({
		//url: "https://ec2-23-23-229-46.compute-1.amazonaws.com:8443/jsppages/getaccesstoken.jsp?cid=149169311831203",
		//https://scdev.mykorn.com/sc-app-prod/getaccesstoken.jsp?cid=149169311831203,
		//https://apps.standardchartered.com/sc-app-prod/getaccesstoken.jsp?cid=149169311831203
		url: "https://token.labsls.com:8443/getaccesstoken.jsp",
		dataType: "jsonp",
		jsonp : "callback",
...
$(img).bind({
    ...
    $(img).attr('src','../global/assets/global/images/country/sc-fb-logo.jpg');
   ...
   }else
   {
	...
	for(keys in rtndata.data)
	{
			 ...
			 if(typeof indiv_feeds.likes  != "undefined" && showlikes)
			 {
				  ...
				  like_count = indiv_feeds.likes.data.length;
				  //alert('likes: ' + indiv_feeds.likes.data)
			  ...
			  if(typeof indiv_feeds.comments  != "undefined" && showComment)
			 {
				  ...
				  comment_count = indiv_feeds.comments.data.length;
				  //alert('comments: ' + indiv_feeds.comments.data)
