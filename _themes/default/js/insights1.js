 ...
 */
var pager = {total:0,limit:5,pageNumber:1,paramMap:{regionId:"0",newsCategoryId:"21",publishPeriodType:"0"}};

var category_list = ["RMB Research", "RMB Insights", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"];

var paraObj = {};
paraObj["region"] = "All regions";
paraObj["category"] = "RMB News";
...
function dwrInit() {
    ...
    if(paraLength == 1 && unescape(paraObj["region"]) == "All regions" && paraObj["category"] == "RMB News"){//the first time to load the news-media listing page
...
function _newsCategoryCallBackV2(newsCategoryList) {
    ...
    $("#newsCategory").append("<li class='radio active selected'>" +
                                      "<input type='radio' id='search-news-category-0' name='grp-news-category' checked='checked' value='21'>" +
                                      "<label for='search-news-category-0'>RMB News</label></li>");
    ...
    for (i = 0; i < newsPagerList.length; i++) {
        ...
        if(newsVO.featured == '1'){
            ...
            $("#featured-news").append("<li class='item article' style='padding-right:0px;'>"+
									"<a href='/en/news-and-media/news/"+newsVO.dcrPath.replace(/.xml/, ".html")+"' ><img src='"+newsVO.listingImage+"' width='168' height='95' alt='"+title+"' + title='"+title+"' /></a> "+
									"<h4><a href='/en/news-and-media/news/"+newsVO.dcrPath.replace(/.xml/, ".html")+"' >"+title+"</a></h4>"+
            ...
            $("#recent-news").append("<li class='item' style='padding-right:0px;'>"+
                                    "<h3><a href='/en/news-and-media/news/"+newsVO.dcrPath.replace(/.xml/, ".html")+"' >"+title+"</a></h3>"+
